...
from pages import home, about, page_not_found, page_boxplot_comparacao
...
navbar = dbc.NavbarSimple(
    children=[
        dbc.NavItem(dbc.NavLink("Boxplots", href="/comparacao-boxplot")),
...
def display_page(pathname):
    if pathname == '/':
        return home.layout
    elif pathname == "/comparacao-boxplot":
        return page_boxplot_comparacao.layout
    elif pathname == '/home':
        return home.layout
    elif pathname == '/about':
        return about.layout
